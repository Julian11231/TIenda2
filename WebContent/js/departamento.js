...
"ajax" : "../servicios/departamento/listarD",
"columns" : [ 
{"data" : "codigo"},
{"data" : "nombre"},
{"data" : "estado"}
...
r.setURI(REST.apiURL + "/departamento/adicionarD");
r.setMethod("POST");
...
var nombre = document.getElementById("nombre").value;
var r = new REST.Request();
r.setURI(REST.apiURL + "/departamento/modificarD/" + codigo);
r.setMethod("PUT");
r.setContentType("application/json");
r.setEntity({
nombre : nombre
...
var codigo = document.getElementById("codigo").value;
var r = new REST.Request();
r.setURI(REST.apiURL + "/departamento/desactivarD/" + codigo);
r.setMethod("DELETE");
r.execute(function(status, request, entity) {
mostrarRespuesta(entity);
});
