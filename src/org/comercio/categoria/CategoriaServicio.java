...
public class CategoriaServicio {
	...
	sql = "INSERT INTO categoriaa (cat_nombre)";
	sql = sql + " VALUES (?)";
	...
	sql = "UPDATE categoriaa set cat_nombre=?";
	...
	sql = "UPDATE categoriaa set cat_estado=FALSE";
	sql = sql + " WHERE cat_codigo=?";
	...
	public Response aadicionar(@PathParam(value = "codigo") int codigo) {
	...
	sql = "UPDATE categoriaa set cat_estado=TRUE";
	sql = sql + " WHERE cat_codigo=?";
	...
	mensaje = "{\"mensaje\":\"Error al Activar\"}";
