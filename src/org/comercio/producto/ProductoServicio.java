...
sql = "INSERT INTO producto (pro_nombre, pro_precio, pro_descripcion, pro_descripcion_larga, pro_imagen, pro_categoria)";
...
sentenciaPreparada1.setString(4, producto.getDescripcion_larga());
sentenciaPreparada1.setString(5, producto.getImagen());
sentenciaPreparada1.setInt(6, producto.getCategoria());
...
sql = "UPDATE producto set pro_nombre=?, pro_precio=?, pro_descripcion=?, pro_descripcion_larga=?, pro_imagen=?, pro_categoria=?";
...
sentenciaPreparada1.setString(5, producto.getImagen());
sentenciaPreparada1.setInt(6, producto.getCategoria());
sentenciaPreparada1.setInt(7, codigo);
...
public ProductoLista getProductos(@PathParam(value = "categoria")int categoria) {
...
int subcategoria = rs1.getInt("pro_categoria");
